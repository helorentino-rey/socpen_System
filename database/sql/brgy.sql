...
ADD COLUMN `citymuni_psgc` VARCHAR(25);
UPDATE `tbl_brgy`
SET `citymuni_psgc` = CASE
    WHEN `psgc` BETWEEN '112301000' AND '112301999' THEN '112301000'
    WHEN `psgc` BETWEEN '112303000' AND '112303999' THEN '112303000'
    WHEN `psgc` BETWEEN '112305000' AND '112305999' THEN '112305000'
    WHEN `psgc` BETWEEN '112314000' AND '112314999' THEN '112314000'
    WHEN `psgc` BETWEEN '112315000' AND '112315999' THEN '112315000'
    WHEN `psgc` BETWEEN '112317000' AND '112317999' THEN '112317000'
    WHEN `psgc` BETWEEN '112318000' AND '112318999' THEN '112318000'
    WHEN `psgc` BETWEEN '112319000' AND '112319999' THEN '112319000'
    WHEN `psgc` BETWEEN '112322000' AND '112322999' THEN '112322000'
    WHEN `psgc` BETWEEN '112323000' AND '112323999' THEN '112323000'
    WHEN `psgc` BETWEEN '112324000' AND '112324999' THEN '112324000'
    WHEN `psgc` BETWEEN '112401000' AND '112401999' THEN '112401000'
    WHEN `psgc` BETWEEN '112402000' AND '112402999' THEN '112402000'
    WHEN `psgc` BETWEEN '112403000' AND '112403999' THEN '112403000'
    WHEN `psgc` BETWEEN '112404000' AND '112404999' THEN '112404000'
    WHEN `psgc` BETWEEN '112406000' AND '112406999' THEN '112406000'
    WHEN `psgc` BETWEEN '112407000' AND '112407999' THEN '112407000'
    WHEN `psgc` BETWEEN '112408000' AND '112408999' THEN '112408000'
    WHEN `psgc` BETWEEN '112410000' AND '112410999' THEN '112410000'
    WHEN `psgc` BETWEEN '112411000' AND '112411999' THEN '112411000'
    WHEN `psgc` BETWEEN '112412000' AND '112412999' THEN '112412000'
    WHEN `psgc` BETWEEN '112414000' AND '112414999' THEN '112414000'
    WHEN `psgc` BETWEEN '112501000' AND '112501999' THEN '112501000'
    WHEN `psgc` BETWEEN '112502000' AND '112502999' THEN '112502000'
    WHEN `psgc` BETWEEN '112503000' AND '112503999' THEN '112503000'
    WHEN `psgc` BETWEEN '112504000' AND '112504999' THEN '112504000'
    WHEN `psgc` BETWEEN '112505000' AND '112505999' THEN '112505000'
    WHEN `psgc` BETWEEN '112506000' AND '112506999' THEN '112506000'
    WHEN `psgc` BETWEEN '112507000' AND '112507999' THEN '112507000'
    WHEN `psgc` BETWEEN '112508000' AND '112508999' THEN '112508000'
    WHEN `psgc` BETWEEN '112509000' AND '112509999' THEN '112509000'
    WHEN `psgc` BETWEEN '112510000' AND '112510999' THEN '112510000'
    WHEN `psgc` BETWEEN '112511000' AND '112511999' THEN '112511000'
    WHEN `psgc` BETWEEN '118201000' AND '118201999' THEN '118201000'
    WHEN `psgc` BETWEEN '118202000' AND '118202999' THEN '118202000'
    WHEN `psgc` BETWEEN '118203000' AND '118203999' THEN '118203000'
    WHEN `psgc` BETWEEN '118204000' AND '118204999' THEN '118204000'
    WHEN `psgc` BETWEEN '118205000' AND '118205999' THEN '118205000'
    WHEN `psgc` BETWEEN '118206000' AND '118206999' THEN '118206000'
    WHEN `psgc` BETWEEN '118207000' AND '118207999' THEN '118207000'
    WHEN `psgc` BETWEEN '118208000' AND '118208999' THEN '118208000'
    WHEN `psgc` BETWEEN '118209000' AND '118209999' THEN '118209000'
    WHEN `psgc` BETWEEN '118210000' AND '118210999' THEN '118210000'
    WHEN `psgc` BETWEEN '118211000' AND '118211999' THEN '118211000'
    WHEN `psgc` BETWEEN '118601000' AND '118601999' THEN '118601000'
    WHEN `psgc` BETWEEN '118602000' AND '118602999' THEN '118602000'
    WHEN `psgc` BETWEEN '118603000' AND '118603999' THEN '118603000'
    WHEN `psgc` BETWEEN '118604000' AND '118604999' THEN '118604000'
    WHEN `psgc` BETWEEN '118605000' AND '118605999' THEN '118605000'
    ELSE `citymuni_psgc` -- Keeps current value if no match is found
END;

ALTER TABLE `tbl_brgy`
ADD CONSTRAINT `fk_citymuni_code`
FOREIGN KEY (`citymuni_psgc`) REFERENCES `tbl_citymuni`(`psgc`);
