@section('content')
    <style>
        ...
        /* Styling to make textboxes smaller */
        .small-input {
            width: 200px;
            /* Adjust the width as needed */
            height: 30px;
            /* Consistent height for both fields */
            font-size: 12px;
            /* Consistent font size */
        }

        /* Ensure both inputs are aligned horizontally within their container */
        .row {
            display: flex;
            justify-content: space-between;
            /* Space out inputs */
        ...
        <div class="container mt-5">
            ...
            <form action="{{ route('add.submit') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-4">
                    <label class="label">
                        <strong>3. Permanent Address</strong> - <em>Select region first, then province, then city,
                            and finally your barangay.</em></label>
                    <div class="form-row custom-form-row">
                ...
                <div class="form-group mt-4">
                    <label class="label"><strong>4. Present Address</strong> - <em>Select region first, then
                            province, then city, and finally your barangay.</em></label>
                    <div class="form-row custom-form-row">
                        <div class="col-md-2 mb-3">
                            @php
                                $regions = App\Models\Region::orderBy('col_region', 'asc')->get();
                    ...
                    <div class="form-row custom-form-row">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="pantawid">Pantawid Beneficiary (Benepisyaryo
                                    ng 4Ps)</label>
                            </div>
                            <input type="text" class="form-control mt-2" name="hh_id" id="hh_id_group"
                                style="display:none;" placeholder="Specify HH ID (Itala)">
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="affiliation[]" id="indigenous"
                                    value="Indigenous People">
                                <label class="form-check-label" for="indigenous">Indigenous People (Mga
                                    Katutubo)</label>
                            </div>
                ...
                <div class="form-group mt-4">
                    <label class="label"><strong>12. Spouse Address</strong> - <em>Select region first, then
                            province, then city, and finally your barangay.</em></label>
                    <div class="form-row custom-form-row">
                        <div class="col-md-2 mb-3">
                            <label class="ltitle" for="region">Region <span class="text-danger">*</span></label>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td><label class="ltitle">2. Are you completely dependent on someone in doing
                                            your IADLs?</label></td>
                    ...
                    <div class="form-row custom-form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="eligibility_not_eligible">Not
                                    Eligible</label>
                            </div>
                        </div>
