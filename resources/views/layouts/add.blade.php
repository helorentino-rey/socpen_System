@section('content')
    ...
    <body>
        <div class="container mt-5">
            ...
            <!-- Form Section -->
            <form action="{{ route('add.submit') }}" method="POST" enctype="multipart/form-data" class="add-form">
                @csrf
                ...
                <div class="form-group1 row">
                    ...
                    <div class="col-md-4">
                        <label class="label" for="profile_upload"><strong>Upload Profile Picture: <span
                                    class="text-danger">*</span></strong></label>
                        <input type="file" class="form-control" name="profile_upload" id="profile_upload" accept="image/*" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-row custom-form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="last_name" id="last_name" required maxlength="20"
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="first_name" id="first_name" required maxlength="25"
                                pattern="[A-Z][a-z]*(\s[A-Z][a-z]*)*"
                                title="Please enter only letters, starting each word with a capital letter"
                                oninput="this.value = this.value.replace(/\b\w/g, char => char.toUpperCase())">
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <input maxlength="20" type="text" class="form-control" name="middle_name" id="middle_name"
                                pattern="[A-Z][a-z]*(\s[A-Z][a-z]*)*"
                                title="Please enter only letters, starting each word with a capital letter"
                                oninput="this.value = this.value.replace(/\b\w/g, char => char.toUpperCase())">
                        </div>
               ...
               <div class="form-group">
                    ...
                    <div class="form-row custom-form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input maxlength="20" type="text" class="form-control" name="mother_middle_name" id="mother_middle_name"
                                pattern="[A-Z][a-z]*(\s[A-Z][a-z]*)*"
                                title="Please enter only letters, starting each word with a capital letter"
                                oninput="this.value = this.value.replace(/\b\w/g, char => char.toUpperCase())">
                        </div>
                ...
                <div class="form-group mt-4">
                    <label class="label"><strong>3. PERMANENT ADDRESS -</strong> <span style="font-style:italic;"> Select
                            region first, then province, then city, and finally your barangay</span></label>
                    <div class="form-row custom-form-row">
                    ...
                    <div class="form-row custom-form-row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" name="permanent_address_sitio"
                                placeholder="Sitio/House No./Purok/Street" required maxlength="30" pattern="[A-Za-z0-9,\s\-\/]*"
                ...
                <div class="form-group mt-4">
                    <label class="label"><strong>4. PRESENT ADDRESS -</strong> <span style="font-style:italic;"> Select
                            region first, then province, then city, and finally your barangay</span></label>
                    <div class="form-row custom-form-row">
                        <div class="col-md-4 mb-3">
                            @php
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="form-row custom-form-row">
                        <div class="col-md-4 mb-3">
                            <label class="ltitle" for="date_of_birth">Birth Date <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="place_of_birth_province"
                                id="place_of_birth_province" required maxlength="30" pattern="[A-Z][a-z]*(\s[A-Z][a-z]*)*"
                                title="Please enter only letters, starting each word with a capital letter"
                                oninput="this.value = this.value.replace(/\b\w/g, char => char.toUpperCase())">
                        </div>
                    </div>
                ...
                <div class="form-row custom-form-row">
                    <div class="col-md-4 mb-3">
                        <label class="label" for="age"><strong>7. AGE <span
                                    class="text-danger">*</span></strong></label>
                    ...
                    <div class="form-row custom-form-row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control mt-2" name="hh_id" id="hh_id_group"
                                style="display:none;" placeholder="Specify HH ID (Itala)" maxlength="25" pattern="[0-9\-]*"
                ...
                <div class="form-group mt-4">
                    <label class="label"><strong>12. SPOUSE ADDRESS - </strong> <span style="font-style:italic;"> Select
                            region first, then province, then city, and finally your barangay</span></label>
                    <div class="form-row custom-form-row">
                        <div class="col-md-4 mb-3">
                            <label class="ltitle" for="region">Region <span class="text-danger">*</span></label>
                    ...
                    <div class="form-row custom-form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="spouse_contact" name="spouse_contact"
                                required pattern="\+63\d{10}" maxlength="13"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="children[0][income]"
                                      maxlength="10"  pattern="[0-9,]*" title="Please enter only numbers and commas">
                                </td>
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="form-row custom-form-row">
                        <div class="col-md-4">
                            <label class="ltitle">House Status</label> <span class="text-danger"> *</span><br />
                            <div class="form-check">
                        ...
                        <div class="col-md-8">
                            <label class="ltitle">Living Status</label> <span class="text-danger"> *</span><br />
                            <div class="form-check">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <label class="ltitle" for="pension">Receiving Pension</label> <span
                                            class="text-danger"> *</span><br />
                                        <input type="checkbox" class="form-check-input" id="receiving_pension_yes"
                                            name="receiving_pension" value="Yes"
                                            onclick="handleCheckboxSelectionEco('receiving_pension', true, 'pension_amount', 'pension_source')" />
                                        Yes
                                        <input type="checkbox" class="form-check-input" id="receiving_pension_no"
                                            name="receiving_pension" value="No"
                                ...
                                <tr>
                                    <td>
                                        <label class="ltitle" for="permanent_income">Permanent Income</label> <span
                                            class="text-danger"> *</span><br />
                                        <input type="checkbox" class="form-check-input" id="permanent_income_yes"
                                            name="permanent_income" value="Yes"
                                            onclick="handleCheckboxSelectionEco('permanent_income', true, 'income_amount', 'income_source')" />
                                        Yes
                                        <input type="checkbox" class="form-check-input" id="permanent_income_no"
                                            name="permanent_income" value="No"
                                ...
                                <tr>
                                    <td>
                                        <label class="ltitle" for="regular_support">Regular Support</label> <span
                                            class="text-danger"> *</span><br />
                                        <input type="checkbox" class="form-check-input" id="regular_support_yes"
                                            name="regular_support" value="Yes"
                                            onclick="handleCheckboxSelectionEco('regular_support', true, 'support_amount', 'support_source')" />
                                        Yes
                                        <input type="checkbox" class="form-check-input" id="regular_support_no"
                                            name="regular_support" value="No"
                ...
                <div class="form-group">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td><label class="ltitle">With Existing Illness</label> <span class="text-danger">
                                            *</span></td>
                                    <td>
                                        <input type="checkbox" class="form-check-input" id="existing_illness_yes"
                                            name="existing_illness" value="Yes"
                                            onclick="toggleFields('existing_illness', 'illness_specify')" /> Yes
                                        <input type="checkbox" class="form-check-input" id="existing_illness_none"
                                            name="existing_illness" value="None"
                                ...
                                <tr>
                                    <td><label class="ltitle">With Disability</label> <span class="text-danger">
                                            *</span>
                                    </td>
                                    <td>
                                        <input type="checkbox" class="form-check-input" id="with_disability_yes"
                                            name="with_disability" value="Yes"
                                            onclick="toggleFields('with_disability', 'disability_specify')" /> Yes
                                        <input type="checkbox" class="form-check-input" id="with_disability_none"
                                            name="with_disability" value="None"
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td><label class="ltitle">1. Do you experience difficulty in doing your
                                            ADLs?</label>
                                    <td><input type="checkbox" class="form-check-input" id="difficult_adl_yes"
                                            name="difficult_adl" value="Yes"
                                            onclick="handleCheckboxSelectionFra('difficult_adl', true)" /> Yes
                                        <input type="checkbox" class="form-check-input" id="difficult_adl_no"
                                            name="difficult_adl" value="No"
                                ...
                                <tr>
                                    <td><label class="ltitle">2. Are you completely dependent on someone in doing your
                                            IADLs?</label></td>
                                    <td><input type="checkbox" class="form-check-input" id="dependent_iadl_yes"
                                            name="dependent_iadl" value="Yes"
                                            onclick="handleCheckboxSelectionFra('dependent_iadl', true)" /> Yes
                                        <input type="checkbox" class="form-check-input" id="dependent_iadl_no"
                                            name="dependent_iadl" value="No"
                                ...
                                <tr>
                                    <td><label class="ltitle">3. Are you experiencing weight loss, weakness,
                                            exhaustion?</label></td>
                                    <td><input type="checkbox" class="form-check-input" id="experience_loss_yes"
                                            name="experience_loss" value="Yes"
                                            onclick="handleCheckboxSelectionFra('experience_loss', true)" />
                                        Yes
                                        <input type="checkbox" class="form-check-input" id="experience_loss_no"
                                            name="experience_loss" value="No"
