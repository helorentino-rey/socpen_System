...
@section('content')
    ...
    <style scoped>
        .main-container {
            margin-left: 250px;
            /* Adjust this value based on the actual sidebar width */
            padding: 2rem;
    ...
    <div class="main-container">
        ...
        <div class="section">
            ...
            <div class="grid-container">
                ...
                <input name="contactNumber" type="tel" placeholder="Contact Number" class="col-span-2"
        ...
        <div class="section">
            ...
            <div class="grid-container single-column">
                ...
                <input name="assignedProvince" type="text" placeholder="Assigned Province"
                    value="{{ old('assignedProvince') }}">
            </div>
        </div>
