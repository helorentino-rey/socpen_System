    ...
    <div class="form-wrapper">
            ...
            <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="form-group">
                        ...
                        <input name="houseNum" type="text" value="" placeholder="House No./Zone/Purok/Sitio" />
                        <label>Street</label>
                ...
                <div class="section">
                    ...
                    <div class="form-group">
                        ...
                        <input name="careName" type="text" value="" placeholder="Name of Guardian/Care Giver" />
                    </div>
                </div>
                <div class="section">
                    ...
                    <div class="form-group">
                        ...
                        <input name="relSenior" type="text" value="" placeholder="Relationship of (7) to the Senior Citizen" />
                    </div>
                </div>
                <div class="section">
        ...
        <div class="section">
            ...
            <div class="section">
                ...
                <div class="form-group">
                    <label>What are your sources of income and financial support in the past 6 months (other than your pension/s)?</label>
                    <div class="income-table">
                        ...
                        <div class="income-row">
                            <div><input name="incomeSources" type="checkbox" id="wages" value="Wages/Salaries" />
                            ...
                            <div><input type="text" id="wageIncome" name="wageIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div><input name="incomeSources" type="checkbox" id="profit" value="Profits from Entrepreneurial Activities" />
                            ...
                            <div><input type="text" id="profitIncome" name="profitIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div><input name="incomeSources" type="checkbox" id="household" value="Household Family Members/Relatives" />
                            ...
                            <div><input type="text" id="householdIncome" name="householdIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div><input name="incomeSources" type="checkbox" id="domestic" value="Domestic Family Members/Relatives" />
                            ...
                            <div><input type="text" id="domesticIncome" name="domesticIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div>
                                <input name="incomeSources" type="checkbox" id="international" value="International Family Members/Relatives" />
                            ...
                            <div><input type="text" id="internationalIncome" name="internationalIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div><input name="incomeSources" type="checkbox" id="friends" value="Friends/Neighbors" />
                            ...
                            <div><input type="text" id="friendsIncome" name="friendsIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div><input name="incomeSources" type="checkbox" id="transfer" value="Transfers from the Government" />
                            ...
                            <div><input type="text" id="transferIncome" name="transferIncome" placeholder="Enter amount" /></div>
                        </div>
                        <div class="income-row">
                            <div>
                            ...
                            <div><input type="text" id="otherIncome" name="otherIncome" placeholder="Enter amount" /></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group2">
                        ...
                        <br />
                        <input name="spendPension" type="radio" id="checkup" value="Health check-up and other hospital/medical servies" />
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        ...
                        <input name="livingWith" type="radio" id="livingwithspouse" value="Living with spouse only" />
                        ...
                        <input name="livingWith" type="radio" id="livingwithrelative" value="Living with another relative" />
                        <label for="livingwithrelative">Living with another relative</label>
                        <input name="livingWith" type="radio" id="livingwithunrelated" value="Living with unrelated people" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>In general, do you have any health problems that require you to limit your activities?</label>
                            <div class="radio-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                ...
                                <label for="mealsaday_three"><input type="radio" name="mealsaDay" id="mealsaday_three" value="Three"> At least three</label>
                            </div>
                        </div>
                        <div class="form-wrapper">
                ...
                <section class="form-group">
                    ...
                    <p>On behalf of all the members of my household, I confirm that the information I have provided in this paper is true and represent accurate information of our household.</p>
                    <p>I understand that the data collected from this validation will be processed, managed and maintained in a secure database by the Department of Social Welfare and Development (DSWD). Such data will be used to determine poverty status, serve as basis for research, and in the development and implementation of social protection programs and services to promote the interest of the poor.</p>
                    <p>I authorize DSWD to manage the information, including personal data obtained from the household validation activity and allow the processing and controlled disclosure or transfer of data to its development partners and other stakeholders in accordance with the DSWD policies on data sharing and the provisions of Republic Act NO. 10173 or the Data Privacy Act (DPA) of 2012</p>
                ...
                <section class="certification">
                    ...
                    <p>As Validator hired by DSWD for the purpose of this activity, I confirm that for this household the data.</p>
                    <p>I attest that the information provided in this form was personally obtained and reviewed by me.</p>
                    <p>I further declare that all household information collected and validated was managed with strict confidentiality and protected from unlawful and unauthorized processing.</p>
                    <p>I am aware that any violation committed on the foregoing will be penalized in accordance with pertinent provision of RA 10173 of the Data Privacy Act of 2012</p>
                    <div class="signatures">
                        <div>
                ...
                <section class="eligibility">
                    ...
                    <div class="eligibility-options">
                        <label><input type="radio" name="eligibility" value="eligible"> Eligible</label>
                        <label><input type="radio" name="eligibility" value="non-eligible"> Non-Eligible</label>
                    </div>
                    <div class="remarks">
                        <label>Remarks</label>
