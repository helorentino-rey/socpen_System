...
@section('title', 'Add Beneficiaries')
@section('content')
    <style>
        .container {
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4" style="border: 1px solid black;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="{{ route('admin.beneficiaries.approve') }}" class="nav-link" style="color: black;">Approve
                            Beneficiaries</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.beneficiaries.list') }}" class="nav-link" style="color: black;">List of
                            Beneficiaries</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.beneficiaries.export') }}" class="nav-link" style="color: black;">Export
                            List of Beneficiaries</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="section-header">
                <div class="profile-pic" id="profile_pic">
                    <label class="signature-box"><input type="file" class="file-input" name="profilepic"
            ...
            <div class="form-row">
                <div class="income-table">
                    ...
                    <div class="income-row">
                        ...
                        <div><input type="text" id="affiliation_hhid" name="affiliation_hhid"
                    ...
                    <div class="income-row">
                        ...
                        <div><input type="text" id="affiliation_id" name="affiliation_id"
                                placeholder="Specify" /></div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="income-table">
                    ...
                    <div class="income-row">
                        <div>
                            <label class="signature-box"><input type="file" class="file-input"
                                    name="validatedname" id="validated_name"></label>
                            <label for="validated_name">Signature over printed name</label>
                        </div>
                        <div>
                            <label class="signature-box"><input type="file" class="file-input"
                                    name="validateddesignation" id="validated_designation"></label>
            ...
            <div class="form-row">
                <div class="income-table">
                    ...
                    <div class="income-row">
                        <div>
                            <label class="signature-box"><input type="file" class="file-input" name="encodedname"
                                    id="encoded_name"></label>
                            <label for="encoded_name">Signature over printed name</label>
                        </div>
                        <div>
                            <label class="signature-box"><input type="file" class="file-input"
                                    name="encodeddesignation" id="encoded_designation"></label>
            ...
            <div class="form-row">
                <div class="form-col">
                    <label class="form-label">By signing this form, I grant my free and voluntary consent for the
                        Department of Social Welfare and Development (DSWD) to collect, process, and share my personal
                        information for the purpose of validation, eligibility test, and cross-matching to serve as the
                        basis in granting my entitlements as a qualified beneficiary of the Social Pension for Indigent
                        Senior Citizens (SPISC) Program. As a data subject, I understand that I have the right to be
                        informed, access, object, block, file complaints or damages or rectify my personal information
                        obtained, processed, or shared as well as the purpose and reason for processing or sharing this
            ...
            <div class="form-row">
                <div class="income-table">
                    ...
                    <div class="income-row">
                        <div>
                            <label class="signature-box"><input type="file" class="file-input"
                                    name="conformedname" id="conformed_name"></label>
                            <label for="conformed_name">Name of Applicant</label>
                        </div>
                        <div>
                            <label class="signature-box"><input type="file" class="file-input"
                                    name="conformedsignature" id="conformed_signature"></label>
