<head>
    ...
    <style>
        ...
        body::before {
            ...
            position: absolute;
            top: -80px;
            /* Move the background further up */
            left: -80px;
            /* Move the background further left */
            width: calc(100% + 160px);
            /* Increase width beyond the screen */
            height: calc(100% + 160px);
            /* Increase height beyond the screen */
    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="form-images text-center">
                ...
                <img src="{{ asset('img/BagongPilipinas.png') }}" alt="Bagong Pilipinas"
                    class="form-logo bagong-pilipinas">
                <img src="{{ asset('img/social-pension-logo.png') }}" alt="Social Pension Logo"
                    class="form-logo social-pension">
            </div>
            ...
            <form method="POST" action="{{ route('register.submit') }}" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <div class="input-group">
                        <input type="text" id="address" name="address" placeholder="Address" maxlength="50"
                            required>
                        <input type="tel" id="contact_number" name="contact_number" placeholder="Contact Number"
                ...
                <div class="form-section">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="Email" maxlength="25"
                            required>
                        <input type="password" id="password" name="password" placeholder="Password" required
                            minlength="8" maxlength="8">
                        <input type="password" id="password_confirmation" name="password_confirmation"
                            placeholder="Confirm Password" required minlength="8" maxlength="8">
