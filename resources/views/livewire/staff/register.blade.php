    ...
    <div class="container">
        <div class="form-container">
            <form method="POST" action="{{ route('register.submit') }}" enctype="multipart/form-data">
                ...
                <span aria-hidden="true">&times;</span>
                   ...
                   <img src="{{ asset('img/DSWDColored.png') }}" alt="DSWD Logo" class="img-fluid" style="max-height: 60px;">
                   <img src="{{ asset('img/BagongPilipinas.png') }}" alt="Bagong Pilipinas Logo" class="img-fluid" style="max-height: 80px;">
        ...
        <div class="row">
            <div class="col-md-6 mb-2 form-group">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" required minlength="8" maxlength="8">
            </div>
            <div class="col-md-6 mb-2 form-group">
